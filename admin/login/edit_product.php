...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE product SET title='$title', shortDesc='$shortdescription' WHERE id='$product_id'";
    ...
    $blog_id = $_GET['id'];
    $query = "SELECT * FROM product WHERE id='$blog_id'";
        ...
        <div class="content-wrapper content-wrapper--with-bg">
            ...
            <input type="hidden" name="product_id" value="<?php echo $row['id']; ?>">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ProductTitle" aria-describedby="title" name="ProductTitle"value="<?php echo $row['title'];?>"
                            placeholder="Enter Title">
                        <small class="form-text text-muted">Edit product
                        </small>
                    </div>

                    <div class="form-group">
                        <label for="shortdescription">short description</label>
                        <input type="text" class="form-control" id="shortdescription" aria-describedby="title" name="shortdescription" 
                            placeholder="Enter short description" value="<?php echo $row['shortDesc']?>" >
                        <small class="form-text text-muted">With in 100 words
                        </small>
                    </div>
