...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE blog SET title='$title', content='$content', date='$date', url='$url' WHERE id='$blog_id'";
            ...
            <div class="container mt-5">
                ...
                <input type="hidden" name="blog_id" value="<?php echo $row['id']; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="titleContent" rows="3" name="content"><?php echo $row['content'] ?>"</textarea>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-url" name="url" aria-describedby="basic-addon3" value="<?php echo $row['url'] ?>">
                    </div>

                    <div class="mb-3">
                        <label for="formFile" class="form-label">Upload your Image</label>
                        <input class="form-control" type="file" id="formFile" name="uploadfile" value="<?php echo $row['file'] ?>" >
                    </div>
