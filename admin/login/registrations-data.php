...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $delete_sql = "DELETE FROM registrations_table WHERE sl = '$record_id'";
  $delete_result = mysqli_query($conn, $delete_sql);

  // Check if the delete operation was successful
  if ($delete_result) {
    header("Location: registrations-data.php"); // Redirect to the home page after deletion
  } else {
...
<body class="sidebar-is-reduced">
  <header class="l-header">
    <div class="l-header__inner clearfix">
      ...
      <!-- <div class="c-header-icon has-dropdown"><span
          class="c-badge c-badge--red c-badge--header-icon animated swing">13</span><i class="fa fa-bell"></i>
  ...
  <main class="l-main">
    <div class="content-wrapper content-wrapper--with-bg">
      <h1 class="page-title" style="color:white;">Registrations</h1>




      <div class="tablecontainer" style="margin: 20px;border: 1px dotted green; box-shadow: 4px 5px 6px deepskyblue;">
        <?php
        if ($rowcountofRegistrations > 0) {
          ?>
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              <tr style="color: white;">
                ...
                <form method="post" action="" onsubmit="return confirmDelete();">
                  <input type="hidden" name="record_id" style="display:none;" value="<?php echo $row["sl"]; ?>">
