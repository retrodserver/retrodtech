...
$(document).ready(function() {
    document.getElementById('submit2').addEventListener('click', function(e) {
        ...
        const checkboxes = document.querySelectorAll('#form2 input[type="checkbox"]');
        const checkedValues = [];
        ...
        $.ajax({
            type: 'GET',
            url: 'https://retrodtech.com/include/storeitem2.php', // Adjust the path to the actual location of your PHP file
